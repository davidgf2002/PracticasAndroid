...
public class LugaresLista implements RepositorioLugares {
    protected List<com.example.firebase_authentication.Lugar> listaLugares;

    public LugaresLista() {
        listaLugares = new ArrayList<com.example.firebase_authentication.Lugar>();
        añadeEjemplos();
    }

    public com.example.firebase_authentication.Lugar elemento(int id) {
        return listaLugares.get(id);
    }

    public void añade(com.example.firebase_authentication.Lugar lugar) {
        listaLugares.add(lugar);
    }

    public int nuevo() {
        com.example.firebase_authentication.Lugar lugar = new com.example.firebase_authentication.Lugar();
        listaLugares.add(lugar);
    ...
    public void actualiza(int id, com.example.firebase_authentication.Lugar lugar) {
